...
namespace Aciertagol.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Alberto", "De Jesus Espinoza", "aljestudios@gmail.com", "7471620382", "Calle Luna Calle Sol", UserType.Admin);
            await CheckUserAsync("2020", "Alexis", "Roldan Reyes", "ale_rore@hotmail", "7471104205", "Calle Luna Calle Sol", UserType.Admin);
            await CheckUserAsync("3030", "Alexis", "De Jesus Espinoza", "a_de_jesus_espinoza@hotmail.com", "7471620382", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("4040", "Liones", "De Jesus Bracamontes", "aljestudios@gmail.com", "7471620382", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("5050", "Iker", "De Jesus Bracamontes", "aljestudios@hotmail.com", "7471620382", "Calle Luna Calle Sol", UserType.User);
        ...
        private async Task CheckTournamentsAsync()
        {
            if (!_context.Tournaments.Any())
            {
                ...
                _context.Tournaments.Add(new TournamentEntity
                {
                    ...
                    EndDate = endDate,
                    IsActive = true,
                    LogoPath = $"~/images/Tournaments/UEFA Champions League 2020.png",
